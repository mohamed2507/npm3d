...
from model.dense_block import get_block


class DenseUNet(ME.MinkowskiNetwork):
    NORM_TYPE = None
    BLOCK_NORM_TYPE = 'BN'
...
class DenseUNetBN2(DenseUNet):
    NORM_TYPE = 'BN'


class DenseUNetBN2B(DenseUNet):
    NORM_TYPE = 'BN'
    CHANNELS = [None, 32, 64, 128, 256]
    TR_CHANNELS = [None, 64, 64, 64, 64]


class DenseUNetBN2C(DenseUNet):
    NORM_TYPE = 'BN'
    CHANNELS = [None, 32, 64, 128, 256]
    TR_CHANNELS = [None, 64, 64, 64, 128]


class DenseUNetBN2D(DenseUNet):
    NORM_TYPE = 'BN'
    CHANNELS = [None, 32, 64, 128, 256]
    TR_CHANNELS = [None, 64, 64, 128, 128]


class DenseUNetBN2E(DenseUNet):
    NORM_TYPE = 'BN'
    CHANNELS = [None, 128, 128, 128, 256]
    TR_CHANNELS = [None, 64, 128, 128, 128]


class DenseUNetIN2(DenseUNet):
    NORM_TYPE = 'BN'
    BLOCK_NORM_TYPE = 'IN'
...
class DenseUNetIN2B(DenseUNetBN2B):
    NORM_TYPE = 'BN'
    BLOCK_NORM_TYPE = 'IN'


class DenseUNetIN2C(DenseUNetBN2C):
    NORM_TYPE = 'BN'
    BLOCK_NORM_TYPE = 'IN'


class DenseUNetIN2D(DenseUNetBN2D):
    NORM_TYPE = 'BN'
    BLOCK_NORM_TYPE = 'IN'


class DenseUNetIN2E(DenseUNetBN2E):
    NORM_TYPE = 'BN'
    BLOCK_NORM_TYPE = 'IN'
